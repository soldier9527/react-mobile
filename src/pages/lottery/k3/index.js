                        ...
                        <div className="long_board">
                            <ul>
                                {numArr.map((num,j)=>{
                                    ...
                                    return <li key={j}  onClick={()=>{this.setCart(i,num)}}>
                                        <span className={cart[i]&&cart[i].indexOf(num) !==-1?"k3-0"+a:"k3-"+a}></span>
                                        <span className={cart[i]&&cart[i].indexOf(num) !==-1?"k3-0"+b:"k3-"+b}></span>
                                    </li>
                                })}
                            </ul>
                        </div>
                    ...
                    <div className="ch_chart " key={f+"_"+i}>
                        ...
                        <div className={this.props.md.mg_name[0]=="三军"?"one_num":"three_num"}>
                            <ul>
                                ...
                                {codeArr.map((num,j)=>{
                                    return(<li key={j}
                                        onClick={()=>{this.props.handlechooseNum(i,num,"","",f)}}  className={cart[f]&&cart[f][i]&&cart[f][i].indexOf(num) !==-1?"on k3-0"+num:"off k3-"+num}>
